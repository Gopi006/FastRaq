...
public class GeetingAgeAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			String role = null;
			role = new UserdaoImpl().getAge(login, age);
			if (role != null) {

				request.setAttribute("status", "Your Age is Correct");

				path = "./verifysignature.jsp";
			} else {
