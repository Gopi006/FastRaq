...
public class StorageServicesAction extends HttpServlet {

	/**
	 * 
	 */

	Logger log = Logger.getLogger(StorageServicesAction.class);
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Vector v = new UserdaoImpl().retreveFilesFromServer4(rto);
