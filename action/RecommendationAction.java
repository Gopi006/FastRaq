...
public class RecommendationAction extends HttpServlet {

	/**
	 * 
	 */

	Logger log = Logger.getLogger(RecommendationAction.class);
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Vector v = new UserdaoImpl().Recommendation(rto);
