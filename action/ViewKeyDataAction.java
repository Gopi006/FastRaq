...
public class ViewKeyDataAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			serverid = Integer.parseInt(request.getParameter("keyServerid"));
			al = new AdminDAO().viewKeyStorageDetails(serverid);
			if (!al.isEmpty()) {
				path = UtilConstants._VIEW_KEY_SERVERS_DETAILS;
