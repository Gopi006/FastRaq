...
public class CheckUserIDAvail extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (userid == null || userid == "") {
			...
			out
					.println("<center><font color=red>Enter user id</font></center>");
		} else {
			if (flag) {
				request.setAttribute("v", v);
				out
						.println("<center><font color=white>This username Already  available</font></center>");
			} else {
				request.setAttribute("v", v);
				out
						.println("<center><font color=white> This user Not available</font></center>");
			}
		}
		out.flush();
		out.close();
