...
public class AdminDAO extends AbstractDataAccessObject {
	...
	public ArrayList<StorageServerBean> viewStorageServers()
	...
	public ArrayList<StorageServerBean> viewStorageDetails(int serverid)
			throws DataNotFoundException, ConnectionException {
	...
	public ArrayList<KeyServerBean> viewKeyStorageDetails(int serverid)
			throws DataNotFoundException, ConnectionException {
	...
	public ArrayList<RegisterBean> viewUsers() throws DataNotFoundException,
			ConnectionException {
	...
	public ArrayList<KeyServerBean> viewKeyServers()
			throws DataNotFoundException, ConnectionException {
